...
Windows: [![Build
status](https://ci.appveyor.com/api/projects/status/agi7g487s4g53u4p)](https://ci.appveyor.com/project/karthik/rfisheries)  
![CRAN_downloads](http://cranlogs.r-pkg.org/badges/rfisheries)

![beta
logo](https://raw.github.com/ropensci/rfisheries/master/betaLogo.png)

beta logo

This package provides programmatic access to the
[openfisheries](http://openfisheries.org/)
[API](http://openfisheries.org/api-info). Open Fisheries is a platform
that aggregates global fishery data and currently offers global fish
capture landings from 1950 onwards (more data coming soon). Read more
about that effort [here](http://openfisheries.org/about).
...
or grab the development version. To install this version you’ll need the
...
Package currently provides three basic functions. Landings data can be
obtained by calling
...
If you don’t have know the correct species or country codes, you can get
a complete list with the following two functions.
...
![multiple
countries](https://raw.github.com/ropensci/rfisheries/master/multiple_countries.png)

multiple countries

Similarly you can get landings data for multiple species. As the API
evolves, we’ll update the package and get it to
[CRAN](http://cran.r-project.org/) at some point.

## Creative interactive charts

Using the [rCharts library](http://ramnathv.github.io/rCharts/), it’s
easy to create interactive plots. Here’s a quick example.
...
bugs](https://github.com/ropensci/rfisheries/issues).
